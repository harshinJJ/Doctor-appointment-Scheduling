...
const Productcategories = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `http://localhost:8080/products/productcatogerydetails/${catogeries}`,
        {
          headers: {
  ...
  return (
    <div className="bgcolo">
      <br />
      <br />
      <span class="productheading1">{catogeries}</span>
      <br />
      <br />
